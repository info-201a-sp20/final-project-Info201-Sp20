                     ...
                     sidebarLayout(
                       sidebarPanel(
                         ...
                         p("This plot attempts to show how genres have gained or
                           ...
                           genre's popularity. Frequency was measured by
                           counting the number of times the respective genre
                           appeared in the list of the top 10 artists from each
                           year. If a genre showed up 5 out of 10 times, it has
                           a 50% frequency. The more frequent a genre appears,
                           the more popular it was that year.")),
                       mainPanel(plotlyOutput("genre_plot"))),
                fluidPage(
