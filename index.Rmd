...
We found that the song that made the most amount of revenue in one year was *`r summary_list[3]`*. This occured during the year `r summary_list[4]`. The song
that made the least amount of revenue in one year was *`r summary_list[7]`*,
which occured during the year `r summary_list[8]`.
